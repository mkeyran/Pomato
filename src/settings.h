...
class Settings : public QObject {
    ...
    Q_PROPERTY (QString hotkeyStart READ hotkeyStart WRITE setHotkeyStart NOTIFY hotkeyStartChanged)
    Q_PROPERTY (QString hotkeyPause READ hotkeyPause WRITE setHotkeyPause NOTIFY hotkeyPauseChanged)
    Q_PROPERTY (QString hotkeyStop READ hotkeyStop WRITE setHotkeyStop NOTIFY hotkeyStopChanged)
public:
    ...
    QString hotkeyStart() const
    {
        return m_hotkeyStart;
    }

    QString hotkeyPause() const
    {
        return m_hotkeyPause;
    }

    QString hotkeyStop() const
    {
        return m_hotkeyStop;
    }
...
signals:
    ...
    void hotkeyStartChanged (QString hotkeyStart);

    void hotkeyPauseChanged (QString hotkeyPause);

    void hotkeyStopChanged (QString hotkeyStop);
...
public slots:
    ...
    void setHotkeyStart (QString hotkeyStart);

    void setHotkeyPause (QString hotkeyPause);

    void setHotkeyStop (QString hotkeyStop);
...
private:
    ...
    QSettings settings;
    QString m_hotkeyStart;
    QString m_hotkeyPause;
    QString m_hotkeyStop;
};
